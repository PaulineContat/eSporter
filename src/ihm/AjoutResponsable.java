...
public class AjoutResponsable extends JDialog {
	 ...
	 * @throws SQLException 
	 */
	public AjoutResponsable() throws SQLException {
	...
	private void ajouterResponsable() {
		if (this.tousLesChampsCorrects()) {
			...
			ConnexionBDD.enregistrerResponsable(new Responsable(this.getNom(), this.getPrenom(), this.getTelephone(), Compte.passwordHash(getMDP())));
		}
	}
	
	public static void main(String[] args) throws SQLException {
		AjoutResponsable r = new AjoutResponsable();
		r.setVisible(true);
	}
